---
layout: default
title: "Recommendation #5: Strategize Intentional No-AI Tasks"
parent: 4. Five Recommendations for Assessing Design·AI Education
nav_order: 5
---

# Recommendation #5:  Strategize intentional no-AI tasks
...
At SUTD, students also develop their critical AI literacy to know when to develop, use, or set aside AI for a given task. This three-pronged approach marks SUTD's unique stance on AI. By establishing the common understanding to treat AI as "Tool, Teammate, or Neither" (TTN), the university strives to enhance students' human intelligence and their potential to thrive in the AI Age. For example, in 51.514 "Applied Data Privacy for AI Systems," Victor Keong (ISTD) adopts what he calls the "Foundation First, then AI-fy" approach. In the course's lab components, students first work through the foundational technique (such as *k*-anonymity, differential privacy, and federated learning) using Python code manually. In doing so, students understand the mechanics of privacy-preserving systems at the code and logic level. Only after that foundation is built, does he introduce students to LLMs and demonstrate prompting patterns for the same results, but faster. This sequencing offers students a first-hand experience of how the field of computer science has evolved. Rather than perceiving AI as a shortcut, therefore, students come to see themselves as participants in this transformation precisely because they understand the foundations.
